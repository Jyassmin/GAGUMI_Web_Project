...
<head>
    ...
    <!--product-create 스타일-->
    <link rel="stylesheet" href="info-update.css?after">
    <meta charset="UTF-8">
    ...
    <section id="updateInfo">
        ...
        <form id="updateForm" action="info-update-request.jsp" method="post">
            <div>
                ...
                <p><span>비밀번호</span> <input id="modify_pw" name="modify_pw" type="password"></p>
                <p><span>비밀번호 확인</span> <input type="password" id="pw_check"></p>
