...
<%
    ...
    int check_account = userDao.login(uemail, upw); // 로그인 실패 0, 성공 1
    ...
    script.println("<script>");
    if (check_account == 1) {
        session.setAttribute("memberEmail", uemail); // 세션생성
