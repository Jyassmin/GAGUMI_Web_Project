INSERT INTO customer (name, email, pw, phone, gender, birthday, address)
VALUES
    ('김영희', 'younghi92@gmail.com', 'alicepass', '01012311234', 0, '1992-06-25', '서울특별시 강남구 역삼동 123번지'),
...
INSERT INTO seller (name, email, pw, phone, company, address)
VALUES
    ('가구마트', 'galoreinfo@gmail.com', 'furniture123', '01011112222', '가구마트 주식회사', '서울특별시 강남구 메인로 123'),
    ('홈액센츠', 'accentscontact@naver.com', 'homeaccentspw', '01033334444', '홈액센츠 주식회사', '서울특별시 서초구 박스아파트 456'),
    ('우아한디자인', 'elegantdesigns@daum.net', 'elegant123', '01055556666', '우아한디자인 주식회사', '서울특별시 강북구 은행길 789'),
    ('편안한리빙', 'comfortliving@gmail.com', 'comfortpass', '01077778888', '편안한리빙 주식회사', '서울특별시 종로구 오크아파트 101'),
    ('모던인테리어', 'interiorsmodern@naver.com', 'modern123', '01099990000', '모던인테리어 주식회사', '서울특별시 송파구 단풍로 234');
...
INSERT INTO product (sid, ca2id, name, stock, cost, `desc`, pimage, size)
VALUES
    -- 의자
    (1, 1, '우아한 식탁의자', 20, 100000, '식탁을 더욱 우아하게 만들어주는 식탁의자입니다.', '../images/empty-image.png', '중형'),
    (2, 1, '모던한 스툴', 15, 120000, '모던한 디자인의 스툴로 다용도로 사용할 수 있습니다.', '../images/empty-image.png', '소형'),
    (3, 1, '클래식한 나무 의자', 10, 110000, '클래식한 디자인의 나무 의자입니다.', '../images/empty-image.png', '중형'),
    (4, 1, '모던 원형 의자', 8, 130000, '모던한 원형 디자인의 의자입니다.', '../images/empty-image.png', '소형'),
    (5, 1, '심플한 플라스틱 의자', 12, 95000, '심플한 디자인의 플라스틱 의자입니다.', '../images/empty-image.png', '소형'),
    (5, 2, '깔끔한 화장대', 12, 145000, '깔끔한 디자인의 화장대입니다.', '../images/empty-image.png', '소형'),
    (5, 2, '원목 나무 화장대', 12, 200000, '원목으로 만든 나무 화장대입니다.', '../images/empty-image.png', '소형'),

    -- 소파
    (1, 3, '소형 소파', 8, 150000, '작지만 편안한 소형 소파입니다.', '../images/empty-image.png', '소형'),
    (2, 4, '중형 소파', 5, 180000, '편안한 중형 소파로 가족과 함께 시간을 보내보세요.', '../images/empty-image.png', '중형'),
    (3, 5, '큰 소파', 3, 220000, '큰 공간을 채울 수 있는 편안한 큰 소파입니다.', '../images/empty-image.png', '대형'),
    (4, 5, '모던한 소파', 6, 190000, '모던한 디자인의 소파로 공간을 더욱 화사하게 만들어줍니다.', '../images/empty-image.png', '중형'),
    (5, 5, '코지 침대 소파', 9, 210000, '편안한 코지 침대 소파로 여유로운 시간을 즐겨보세요.', '../images/empty-image.png', '중형'),

    -- 서랍/수납장
    (1, 6, '다용도 서랍', 10, 120000, '다양한 물건을 수납할 수 있는 다용도 서랍입니다.', '../images/empty-image.png', '중형'),
    (3, 6, '큰 서랍', 5, 150000, '다양한 물건을 넣을 수 있는 큰 서랍입니다.', '../images/empty-image.png', '대형'),
    (4, 6, '파일 서랍', 7, 110000, '파일과 문서를 정리할 수 있는 서랍입니다.', '../images/empty-image.png', '중형'),
    (2, 7, '작은 수납장', 6, 90000, '작지만 유용한 작은 수납장입니다.', '../images/empty-image.png', '소형'),
    (5, 7, '고급 나무 수납장', 4, 180000, '고급스러운 나무 수납장으로 공간을 더욱 화사하게 만들어줍니다.', '../images/empty-image.png', '중형'),

    -- 테이블
    (1, 8, '편안한 책상', 8, 140000, '편안하게 공부하거나 일할 수 있는 책상입니다.', '../images/empty-image.png', '중형'),
    (2, 8, '큰 책상', 6, 160000, '다양한 물건을 놓을 수 있는 큰 책상입니다.', '../images/empty-image.png', '대형'),
    (3, 9, '큰 식탁', 5, 220000, '다양한 사람들과 함께 식사를 할 수 있는 큰 식탁입니다.', '../images/empty-image.png', '대형'),
    (4, 9, '파티용 테이블', 4, 250000, '파티나 모임에 적합한 큰 테이블입니다.', '../images/empty-image.png', '대형'),
    (5, 9, '다용도 접이식 테이블', 7, 180000, '다용도로 사용할 수 있는 편리한 접이식 테이블입니다.', '../images/empty-image.png', '중형'),

    -- 침대
    (1, 10, '편안한 침대', 10, 280000, '편안하게 잠을 청할 수 있는 편안한 침대입니다.', '../images/empty-image.png', '킹사이즈'),
    (2, 10, '큰 침대', 6, 320000, '공간을 편안하게 채우는 큰 침대입니다.', '../images/empty-image.png', '퀸사이즈'),
    (3, 10, '모던한 침대', 8, 270000, '모던한 디자인의 침대로 공간을 더욱 화사하게 만들어줍니다.', '../images/empty-image.png', '퀸사이즈'),
    (4, 10, '고급스러운 침대', 5, 350000, '고급스러운 느낌의 침대입니다.', '../images/empty-image.png', '킹사이즈'),

    -- 장롱
    (5, 11, '수납이 넓은 장롱', 12, 240000, '작은 공간에도 적합한 수납이 넓은 장롱입니다.', '../images/empty-image.png', '중형'),
    (5, 11, '나무 원목 장롱', 20, 340000, '나무 원목으로 만든 장롱입니다.', '../images/empty-image.png', '대형');


INSERT INTO shoppingcart (cid, pid, quantity)
VALUES
    (1, 1, 2),
    (1, 5, 1),
    (1, 12, 3),
...
INSERT INTO history (cid, pid, oid, quantity, pname, cost, datetime)
VALUES
    -- cid 1
...
INSERT INTO comment (rid, cid, text, datetime, like_yn)
VALUES
