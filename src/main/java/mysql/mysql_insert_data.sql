...
VALUES
    ('김영희', 'test', '12341234', '010-1234-5678', 0, '1992-06-25', '서울특별시 강남구 역삼동 123번지', '00001'),
    ('이철수', 'chulsoo89@naver.com', 'david123', '010-5675-5678', 1, '1989-09-15', '서울특별시 서초구 방배동 456번지', '00002'),
    ('박지민', 'jimin98@daum.net', 'emilypass', '010-9879-9876', 0, '1998-02-10', '인천광역시 부평구 부평동 789번지', '00003'),
    ('김태영', 'taeyoung85@gmail.com', 'jamespass', '010-5555-1234', 1, '1985-12-01', '대구광역시 중구 동인동 101번지', '00004'),
    ('김지연', 'jiyeon94@naver.com', 'oliviapw', '010-7777-2222', 0, '1994-08-18', '부산광역시 해운대구 우동 202번지', '00005'),
    ('이동호', 'dongho91@daum.net', 'will123', '010-8888-3333', 1, '1991-03-30', '광주광역시 동구 산동 303번지', '00006'),
    ('김미라', 'mira96@gmail.com', 'sophiapass', '010-9999-4444', 0, '1996-11-12', '대전광역시 유성구 봉명동 404번지', '00007'),
    ('송재민', 'jaemin87@naver.com', 'alex123', '010-4444-5555', 1, '1987-05-20', '울산광역시 남구 대현동 505번지', '00008'),
    ('박민우', 'minwoo93@daum.net', 'isabellapw', '010-6666-7777', 0, '1993-10-05', '세종특별자치시 조치원읍 606번지', '00009');
...
VALUES
    ...
    ('홈액센츠', 1, 'accentscontact@naver.com', 'homeaccentspw', '010-3333-4444', '홈액센츠 주식회사', '서울특별시 서초구 박스아파트 456', '00011'),
    ('우아한디자인', 1, 'elegantdesigns@daum.net', 'elegant123', '010-5555-6666', '우아한디자인 주식회사', '서울특별시 강북구 은행길 789', '00012'),
    ('편안한리빙', 1, 'comfortliving@gmail.com', 'comfortpass', '010-7777-8888', '편안한리빙 주식회사', '서울특별시 종로구 오크아파트 101', '00013'),
    ('모던인테리어', 1, 'interiorsmodern@naver.com', 'modern123', '010-9999-0000', '모던인테리어 주식회사', '서울특별시 송파구 단풍로 234', '00014');
...
VALUES
    -- 의자
    (10, 1, '우아한 식탁의자', 20, 100000, '식탁을 더욱 우아하게 만들어주는 식탁의자입니다.', '../images/empty-image.png', '중형'),
    (11, 1, '모던한 스툴', 15, 120000, '모던한 디자인의 스툴로 다용도로 사용할 수 있습니다.', '../images/empty-image.png', '소형'),
    (12, 1, '클래식한 나무 의자', 10, 110000, '클래식한 디자인의 나무 의자입니다.', '../images/empty-image.png', '중형'),
    (13, 1, '모던 원형 의자', 8, 130000, '모던한 원형 디자인의 의자입니다.', '../images/empty-image.png', '소형'),
    (13, 1, '심플한 플라스틱 의자', 12, 95000, '심플한 디자인의 플라스틱 의자입니다.', '../images/empty-image.png', '소형'),
    (14, 2, '깔끔한 화장대', 12, 145000, '깔끔한 디자인의 화장대입니다.', '../images/empty-image.png', '소형'),
    (14, 2, '원목 나무 화장대', 12, 200000, '원목으로 만든 나무 화장대입니다.', '../images/empty-image.png', '소형'),

    -- 소파
    (10, 3, '소형 소파', 8, 150000, '작지만 편안한 소형 소파입니다.', '../images/empty-image.png', '소형'),
    (11, 4, '중형 소파', 5, 180000, '편안한 중형 소파로 가족과 함께 시간을 보내보세요.', '../images/empty-image.png', '중형'),
    (12, 5, '큰 소파', 3, 220000, '큰 공간을 채울 수 있는 편안한 큰 소파입니다.', '../images/empty-image.png', '대형'),
    (13, 5, '모던한 소파', 6, 190000, '모던한 디자인의 소파로 공간을 더욱 화사하게 만들어줍니다.', '../images/empty-image.png', '중형'),
    (14, 5, '코지 침대 소파', 9, 210000, '편안한 코지 침대 소파로 여유로운 시간을 즐겨보세요.', '../images/empty-image.png', '중형'),

    -- 서랍/수납장
    (10, 6, '다용도 서랍', 10, 120000, '다양한 물건을 수납할 수 있는 다용도 서랍입니다.', '../images/empty-image.png', '중형'),
    (12, 6, '큰 서랍', 5, 150000, '다양한 물건을 넣을 수 있는 큰 서랍입니다.', '../images/empty-image.png', '대형'),
    (13, 6, '파일 서랍', 7, 110000, '파일과 문서를 정리할 수 있는 서랍입니다.', '../images/empty-image.png', '중형'),
    (11, 7, '작은 수납장', 6, 90000, '작지만 유용한 작은 수납장입니다.', '../images/empty-image.png', '소형'),
    (14, 7, '고급 나무 수납장', 4, 180000, '고급스러운 나무 수납장으로 공간을 더욱 화사하게 만들어줍니다.', '../images/empty-image.png', '중형'),

    -- 테이블
    (10, 8, '편안한 책상', 8, 140000, '편안하게 공부하거나 일할 수 있는 책상입니다.', '../images/empty-image.png', '중형'),
    (11, 8, '큰 책상', 6, 160000, '다양한 물건을 놓을 수 있는 큰 책상입니다.', '../images/empty-image.png', '대형'),
    (12, 9, '큰 식탁', 5, 220000, '다양한 사람들과 함께 식사를 할 수 있는 큰 식탁입니다.', '../images/empty-image.png', '대형'),
    (13, 9, '파티용 테이블', 4, 250000, '파티나 모임에 적합한 큰 테이블입니다.', '../images/empty-image.png', '대형'),
    (14, 9, '다용도 접이식 테이블', 7, 180000, '다용도로 사용할 수 있는 편리한 접이식 테이블입니다.', '../images/empty-image.png', '중형'),

    -- 침대
    (10, 10, '편안한 침대', 10, 280000, '편안하게 잠을 청할 수 있는 편안한 침대입니다.', '../images/empty-image.png', '킹사이즈'),
    (11, 10, '큰 침대', 6, 320000, '공간을 편안하게 채우는 큰 침대입니다.', '../images/empty-image.png', '퀸사이즈'),
    (12, 10, '모던한 침대', 8, 270000, '모던한 디자인의 침대로 공간을 더욱 화사하게 만들어줍니다.', '../images/empty-image.png', '퀸사이즈'),
    (13, 10, '고급스러운 침대', 5, 350000, '고급스러운 느낌의 침대입니다.', '../images/empty-image.png', '킹사이즈'),

    -- 장롱
    (10, 11, '수납이 넓은 장롱', 12, 240000, '작은 공간에도 적합한 수납이 넓은 장롱입니다.', '../images/empty-image.png', '중형'),
    (14, 11, '나무 원목 장롱', 20, 340000, '나무 원목으로 만든 장롱입니다.', '../images/empty-image.png', '대형');
